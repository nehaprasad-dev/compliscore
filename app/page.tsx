...
export default function Home() {
  return (
    <div className="flex min-h-screen flex-col bg-white">
      <div className="border-b border-zinc-200/70 bg-zinc-50">
      ...
      <header className="border-b border-zinc-200/60">
        <div className="mx-auto flex max-w-5xl items-center justify-between px-4 py-4">
          ...
          <nav className="hidden items-center gap-7 text-sm text-zinc-600 sm:flex">
            <a href="#scanner" className="hover:text-zinc-900">
              Scanner
            </a>
            <a href="#how" className="hover:text-zinc-900">
              How it works
            </a>
            <a href="#lead-form" className="hover:text-zinc-900">
              Pricing
            </a>
          </nav>
      ...
      <main className="flex-1">
        <section className="mx-auto max-w-3xl px-4 pt-14 pb-8 text-center sm:pt-24 sm:pb-12">
          ...
          <p className="mx-auto mt-5 max-w-xl text-[15px] leading-relaxed text-zinc-600 sm:text-base">
            Instant compliance score, missed filings, a rough penalty estimate,
            and a plain-English action plan — for any Indian company, in under
            two seconds.
          </p>
          <p
            id="how"
            className="mt-4 text-[12px] uppercase tracking-[0.18em] text-zinc-400"
          >
        ...
        <section
          id="scanner"
          className="mx-auto max-w-2xl px-4 pb-24 sm:pb-32"
        >
          <Scanner />
        </section>
      </main>
